...
def get_video_name(video_string: str):
    ...
    TODO: Make this work in windows as well! Consider using the version in frame_extractor only!
...
def fill_db_with_thumbnails(
    ...
    """Fill the database with frames from the given frame class."""
...
def execute_filter(neighbours, filter_fun, skip_plots=False, *args, **kwargs):
